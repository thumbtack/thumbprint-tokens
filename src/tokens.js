module.exports = [
    ...
    },
    {
        ...
        tokens: [
            ...
            {
                group: 'Tab Bar Item (iOS)',
                id: 'tab__bar__item__ios__size',
                platforms: {
                    ios: {
                        name: 'tabBarItemSize',
                        value: 'CGFloat = 10',
            ...
            {
                group: 'Tab Bar Item (iOS)',
                id: 'tab__bar__item__ios__weight',
                platforms: {
                    ios: {
                        name: 'tabBarItemWeight',
                        value: 'FontWeight = .bold',
                    },
                },
            },
            {
                group: 'Tab Bar Item Badge (iOS)',
                id: 'tab__bar__item__badge__ios__size',
                platforms: {
                    ios: {
                        name: 'tabBarItemBadgeSize',
                        value: 'CGFloat = 14',
                    },
                },
            },
            {
                group: 'Tab Bar Item Badge (iOS)',
                id: 'tab__bar__item__badge__ios__weight',
                platforms: {
                    ios: {
                        name: 'tabBarItemBadgeWeight',
                        value: 'FontWeight = .normal',
                    },
                },
            },
            {
                group: 'Navigation Bar Title (iOS)',
                id: 'navigation__bar__title__ios__size',
                platforms: {
                    ios: {
                        name: 'navigationBarTitleSize',
                        value: 'CGFloat = 16',
                    },
                },
            },
            {
                group: 'Navigation Bar Title (iOS)',
                id: 'navigation__bar__title__ios__weight',
                platforms: {
                    ios: {
                        name: 'navigationBarTitleWeight',
                        value: 'FontWeight = .bold',
                    },
                },
            },
            {
                group: 'Navigation Bar Large Title (iOS)',
                id: 'navigation__bar__large__title__ios__size',
                platforms: {
                    ios: {
                        name: 'navigationBarLargeTitleSize',
                        value: 'CGFloat = 34',
                    },
                },
            },
            {
                group: 'Navigation Bar Large Title (iOS)',
                id: 'navigation__bar__large__title__ios__weight',
                platforms: {
                    ios: {
                        name: 'navigationBarLargeTitleWeight',
                        value: 'FontWeight = .bold',
                    },
                },
            },
